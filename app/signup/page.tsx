                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input
                                            ...
                                            rounded-xl bg-card bg-opacity-80 
                                            border border-primary focus:outline-none 
                                            focus:ring-2 focus:ring-primary placeholder:text-muted-foreground"
                                            value={name}
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input id="email" type="email"
                                            ...
                                            className="pl-12 py-2 text-base rounded-xl
